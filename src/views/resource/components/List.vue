    ...
    <el-card class="box-card">
      ...
      <el-dialog title="添加资源" :visible.sync="dialogFormVisible">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" @click="onResouceUpdateCancel"
            >取 消</el-button
          >
          <el-button type="primary" @click="onResouceUpdateSubmit"
            >确 定</el-button
          >
        </div>
      </el-dialog>
...
<script lang="ts">
import Vue from 'vue'
import { getResourcePages, deleteResource, createOrUpdateResource } from '@/services/resource'
...
export default Vue.extend({
  ...
  methods: {
    ...
    async onResouceUpdateSubmit () {
      await createOrUpdateResource(this.newForm)
